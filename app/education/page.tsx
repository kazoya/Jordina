...
const items = [
  { title: "جملة الإغلاق", text: "مستورد العراق لا يشتري آيس كريم من كتالوج مكسور. يشتري خطة صيف وأنت توافق على السعر" },
  { title: "ما يدرَّب عليه المندوب", text: "يعيد الوعد كما هو: قائمة تصدير موسمية لا تُرسل لعميل جديد إلا بعد اعتمادك ثم يحول الرسالة بطاقة." },
