...
export const siteConfig = {
  ...
  nameEn: "Jordina",
  brandLine: "JORDINA",
  productName: "تصور مبيعات آيس كريم ومخبوزات ورقائق منذ 1999",
  parentAr: "الشركة السعودية الأردنية للتطوير الصناعي",
  parentEn: "Jordina",
  recipient: "مدير المبيعات",
  recipientRole: "جوردينا",
  country: "الأردن",
  city: "عمّان",
  cityDetailAr: "القسطل بجانب بوابة الشحن الجوي، عمّان",
  since: 0,
  websiteUrl: "https://www.jordinajo.com/",
  defaultMapsUrl: "",
  defaultWhatsAppPhone: "962770478202",
  defaultWhatsAppPrefill: "السلام عليكم جوردينا بخصوص ",
  defaultEmails: ["export@jordina.com.jo"] as const,
  phones: ["962770478202"] as const,
  salesPhone: "962770478202",
